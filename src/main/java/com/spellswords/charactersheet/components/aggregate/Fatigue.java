...
public class Fatigue extends Category {
    ...
    public Fatigue(@NamedArg(value = "prefWidth", defaultValue = "-1") double prefWidth,
                   @NamedArg(value = "text", defaultValue = "Fatigue") String text) {
        super(prefWidth, text);
        FXMLLoader loader = new FXMLLoader(getClass().getResource("Fatigue.fxml"));
        loader.setRoot(this);
